...
object StructuredStreamingFromKafka2HiveBigFile {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rawDF = spark.readStream
      ...
      .option("minOffsetsPerTrigger",2000000)
...
//      .trigger(Trigger.ProcessingTime(10, TimeUnit.SECONDS))
      ...
      .option("checkpointLocation", "hdfs://hadoop102:8020/tmp/offset/test/StructuredStreamingFromKafka2Hive01")
